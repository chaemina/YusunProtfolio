...
const ImageCard = ({ title, tags, image, githubLink, deployLink }) => {
  function getTagColorClass(tagName) {
    const colorMapping = {
      JAVA: "bg-blue",
      "Spring Security": "bg-pink",
      SpringBoot: "bg-orange",
      "My SQL": "bg-black text-white",
    };

    return colorMapping[tagName] || "bg-paragaph";
  }
  return (
    <>
      <div className="w-full">
        <Card className="h-[300px] mb-40 transition duration-300 ease-in-out transform hover:scale-105">
          ...
          <div className="flex">
            ...
            >
              <p className="text-sm mr-2">Github</p>{" "}
              <svg
